      ...
      <div className="bg-search">
        <Grid item xs={12} container className="pd-top-30">
          ...
          <Grid item xs={2} md={2}>
            ...
            <Box>
              <FormControl className="custom-box">
                ...
                <Select labelId="demo-simple-select-label" id="demo-simple-select" value={age} label="Loại nhà đất" onChange={handleChange}>
                  <MenuItem value="">
                    <em>Không chọn</em>
                  </MenuItem>
          ...
          <Grid item xs={2} md={2}>
            <Box>
              <FormControl className="custom-box">
                ...
                <Select labelId="demo-simple-select-label" id="demo-simple-select" value={age} label="Diện tích" onChange={handleChange}>
                  <MenuItem value="">
                    <em>Không chọn</em>
                  </MenuItem>
          ...
          <Grid item xs={2} md={2}>
            <Box>
              <FormControl className="custom-box">
                ...
                <Select labelId="demo-simple-select-label" id="demo-simple-select" value={age} label="Giá" onChange={handleChange}>
                  <MenuItem value="">
                    <em>Không chọn</em>
                  </MenuItem>
          ...
          <Grid item xs={2} md={2}>
            {!isShowAdd && (
              <>
                <p className="text-white pd-top-15 dp-inline-block hover-cursor-pointer" onClick={handleShowAdd}>
                  Hiển thị thêm
                </p>
        ...
        {isShowAdd && (
          <Grid item xs={12} container className="mg-top-15">
            ...
            <Grid item xs={2} md={2}>
              <Box>
                <FormControl className="custom-box">
                  ...
                  <Select labelId="demo-simple-select-label" id="demo-simple-select" value={age} label="Phường xã" onChange={handleChange}>
                    <MenuItem value="">
                      <em>Không chọn</em>
                    </MenuItem>
                  </Select>
            ...
            <Grid item xs={2} md={2}>
              <Box>
                <FormControl className="custom-box">
                  ...
                  <Select labelId="demo-simple-select-label" id="demo-simple-select" value={age} label="Đường phố" onChange={handleChange}>
                    <MenuItem value="">
                      <em>Không chọn</em>
                    </MenuItem>
                  </Select>
            ...
            <Grid item xs={2} md={2}>
              <Box>
                <FormControl className="custom-box">
                  ...
                  <Select labelId="demo-simple-select-label" id="demo-simple-select" value={age} label="Số phòng" onChange={handleChange}>
                    <MenuItem value="">
                      <em>Không chọn</em>
                    </MenuItem>
                  </Select>
            ...
            <Grid item xs={2} md={2}>
              <Box>
                <FormControl className="custom-box">
                  ...
                  <Select labelId="demo-simple-select-label" id="demo-simple-select" value={age} label="Hướng" onChange={handleChange}>
                    <MenuItem value="">
                      <em>Không chọn</em>
                    </MenuItem>
            ...
            <Grid item xs={2} md={2}>
              <p className="text-white pd-top-15 dp-inline-block hover-cursor-pointer" onClick={handleShowHidden}>
                Thu gọn
              </p>
