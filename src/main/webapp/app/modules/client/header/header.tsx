...
const Header = () => {
    ...
    <script>
        ...
        {document.getElementById("linkzalo").href="https://zalo.me/0927346666";}
    </script>
        <a href="https://chat.zalo.me/?phone=0927346666" id="linkzalo" target="_blank" rel="noopener noreferrer"><div id="fcta-zalo-tracking" class="fcta-zalo-mess">
    ...
    <script>
      ...
      chatbox.setAttribute("page_id", "107717202031699");
            ...
            <div className='header-client'>
                <div className='header-content'>
                    <div className='header-image' onClick={() => history.push("/")}>
                        <img src="content/images/changbang_logo.jpg" className='header-image-img' />
                        <span className='header-logo-text'> Mr.Bang Store</span>
                    </div>
