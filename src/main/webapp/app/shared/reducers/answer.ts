...
import { IAnswerDetail, ICreateAnswer, IUpdateAnswer, ITestNameDetail } from '../model/answer';
...
const initialState = {
  ...
  getTestNames: [] as ReadonlyArray<ITestNameDetail>
};
  ...
  extraReducers(builder) {
    builder
      ...
      .addMatcher(isFulfilled(showCourseName), (state, action) => {
        state.loading = false
        state.getTestNames = action.payload.data?.tests;
      })
